namespace periodo_academico.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<periodo_academico.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(ApplicationDbContext context)
        {
            ...
            context.Alunos.AddOrUpdate(a => a.Nome,
                ...
                new Aluno { AlunoId = 8, Nome = "Júlia", TurmaId = 1, Media = 0 },
                new Aluno { AlunoId = 9, Nome = "Heloísa", TurmaId = 1, Media = 0 },
                ...
                new Aluno { AlunoId = 18, Nome = "Théo", TurmaId = 1, Media = 0 },
                ...
                new Aluno { AlunoId = 23, Nome = "Lívia", TurmaId = 2, Media = 0 },
                ...
                new Aluno { AlunoId = 33, Nome = "Cecília", TurmaId = 2, Media = 0 },
                new Aluno { AlunoId = 34, Nome = "Eloá", TurmaId = 2, Media = 0 },
                new Aluno { AlunoId = 35, Nome = "Enzo Gabriel", TurmaId = 2, Media = 0 },
                new Aluno { AlunoId = 36, Nome = "Lara", TurmaId = 2, Media = 0 },
                new Aluno { AlunoId = 37, Nome = "João Miguel", TurmaId = 2, Media = 0 },
                new Aluno { AlunoId = 38, Nome = "Maria Júlia", TurmaId = 2, Media = 0 },
                ...
                new Aluno { AlunoId = 45, Nome = "Ana Júlia", TurmaId = 3, Media = 0 },
                ...
                new Aluno { AlunoId = 50, Nome = "João Pedro", TurmaId = 3, Media = 0 },
